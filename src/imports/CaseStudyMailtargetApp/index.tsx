...
function Hero() {
  return (
    <div className="content-stretch flex flex-col gap-[64px] items-start pb-[80px] pt-[120px] px-[64px] relative shrink-0 w-[1280px]" data-name="hero">
      <p className="[word-break:break-word] font-['Space_Mono:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#6f6f68] text-[12px] tracking-[0.72px] whitespace-nowrap">← Back to work</p>
      <Frame1 />
      <Frame2 />
...
function Frame45() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] items-start relative shrink-0 w-full" data-name="Frame">
      <Frame46 />
      <div className="h-[240px] relative rounded-[12px] shrink-0 w-full" data-name="Rectangle">
        <img alt="" className="absolute inset-0 max-w-none object-contain pointer-events-none rounded-[12px] size-full" src={imgRectangle6} />
      </div>
    </div>
  );
}
...
function Frame50() {
  return (
    <div className="bg-[#0c0c0b] flex-[1_0_0] min-w-px relative rounded-[12px]" data-name="Frame">
      <div aria-hidden className="absolute border border-[rgba(255,255,255,0.08)] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <div className="[word-break:break-word] content-stretch flex flex-col items-start leading-[normal] p-[24px] relative size-full whitespace-nowrap">
        <p className="font-['Space_Mono:Bold',sans-serif] not-italic relative shrink-0 text-[#cc6ef8] text-[18px]">480+</p>
...
function Frame51() {
  return (
    <div className="bg-[#0c0c0b] flex-[1_0_0] min-w-px relative rounded-[12px]" data-name="Frame">
      <div aria-hidden className="absolute border border-[rgba(255,255,255,0.08)] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <div className="[word-break:break-word] content-stretch flex flex-col items-start leading-[normal] p-[24px] relative size-full whitespace-nowrap">
        <p className="font-['Space_Mono:Bold',sans-serif] not-italic relative shrink-0 text-[#cc6ef8] text-[18px]">3</p>
...
function Frame52() {
  return (
    <div className="bg-[#0c0c0b] flex-[1_0_0] min-w-px relative rounded-[12px]" data-name="Frame">
      <div aria-hidden className="absolute border border-[rgba(255,255,255,0.08)] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <div className="[word-break:break-word] content-stretch flex flex-col items-start leading-[normal] p-[24px] relative size-full whitespace-nowrap">
        <p className="font-['Space_Mono:Bold',sans-serif] not-italic relative shrink-0 text-[#cc6ef8] text-[18px]">2</p>
...
function Frame53() {
  return (
    <div className="bg-[#0c0c0b] flex-[1_0_0] min-w-px relative rounded-[12px]" data-name="Frame">
      <div aria-hidden className="absolute border border-[rgba(255,255,255,0.08)] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <div className="[word-break:break-word] content-stretch flex flex-col items-start leading-[normal] p-[24px] relative size-full whitespace-nowrap">
        <p className="font-['Space_Mono:Bold',sans-serif] not-italic relative shrink-0 text-[#cc6ef8] text-[18px]">6</p>
...
function Frame54() {
  return (
    <div className="bg-[#0c0c0b] flex-[1_0_0] min-w-px relative rounded-[12px]" data-name="Frame">
      <div aria-hidden className="absolute border border-[rgba(255,255,255,0.08)] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <div className="[word-break:break-word] content-stretch flex flex-col items-start leading-[normal] p-[24px] relative size-full whitespace-nowrap">
        <p className="font-['Space_Mono:Bold',sans-serif] not-italic relative shrink-0 text-[#cc6ef8] text-[18px]">8+</p>
