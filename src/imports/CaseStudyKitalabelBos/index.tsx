import svgPaths from "./svg-gl3n9k43uw";
  ...
  return (
    <div className="h-[940px] relative shrink-0 w-full" data-name="Hero">
      <div className="content-stretch flex flex-col items-start pt-[120px] px-[64px] relative size-full">
        <p className="[word-break:break-word] font-['Space_Grotesk:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#9a9a93] text-[14px] whitespace-nowrap">← Back to work</p>
        <Frame2 />
      </div>
    </div>
  );
  ...
  return (
    <div className="h-[490px] relative shrink-0 w-full" data-name="Section 01">
      <div className="content-stretch flex flex-col items-start pt-[100px] px-[64px] relative size-full">
        <p className="[word-break:break-word] font-['Space_Mono:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#cc6ef8] text-[12px] tracking-[1.2px] uppercase whitespace-nowrap">01 — Overview</p>
        <Frame101 />
      </div>
    </div>
  );
...
function Frame109() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full" data-name="Frame">
      <p className="font-['Space_Mono:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#cc6ef8] text-[12px] tracking-[1.2px] uppercase whitespace-nowrap">02 — Before this OS</p>
...
function Frame121() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full" data-name="Frame">
      <p className="font-['Space_Mono:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#cc6ef8] text-[12px] tracking-[1.2px] uppercase whitespace-nowrap">03 — Key Screens</p>
...
function Frame652() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full" data-name="Frame">
      <p className="font-['Space_Mono:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#cc6ef8] text-[12px] tracking-[1.2px] uppercase whitespace-nowrap">04 — Key Design Decisions</p>
...
function Frame663() {
  return (
    <div className="content-stretch flex flex-col gap-[40px] items-start leading-[normal] relative shrink-0 w-full whitespace-nowrap" data-name="Frame">
      <p className="font-['Space_Mono:Regular',sans-serif] not-italic relative shrink-0 text-[#cc6ef8] text-[12px] tracking-[1.2px] uppercase">05 — Outcomes</p>
      <Frame664 />
    </div>
  );
}
...
function Frame673() {
  return (
    <div className="[word-break:break-word] content-stretch flex font-['Space_Mono:Regular',sans-serif] items-center justify-between leading-[normal] not-italic relative shrink-0 text-[#9a9a93] text-[11px] w-full whitespace-nowrap" data-name="Frame">
